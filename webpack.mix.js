...
mix.styles([
	'resources/assets/main/bootstrap/css/bootstrap.min.css',
	'resources/assets/main/lightbox/css/lightbox.css',
	'resources/assets/main/styles/main.css',
	'resources/assets/main/styles/white.css'
], 'public/css/main.css');

mix.scripts([
	'resources/assets/main/js/jquery-1.11.3.min.js',
	'resources/assets/main/bootstrap/js/bootstrap.min.js',
	'resources/assets/main/lightbox/js/lightbox.min.js',
	'resources/assets/main//js/isotope.pkgd.min.js',
	'resources/assets/main/js/jquery.scrollTo.min.js',
	'resources/assets/main/assets/js/jquery.nav.min.js',
	'resources/assets/main/js/custom.js'
], 'public/js/main.js');

mix.copy('resources/assets/main/bootstrap/fonts', 'public/fonts');